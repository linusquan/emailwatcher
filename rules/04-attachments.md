# 4. Attachments — Read and Handling

← [index.md](../index.md) · prev: [03-classify.md](./03-classify.md) · next: [05-route-and-write.md](./05-route-and-write.md)
